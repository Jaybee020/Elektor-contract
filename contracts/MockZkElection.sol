...
contract MockZkElection is Tree, ReentrancyGuard,EmbeddedZKPVerifier {
...
//     address public  factory;
    ...
    function mockSubmitZKPResponse() public  {
       _beforeProofSubmit(msg.sender);
       _afterProofSubmit(msg.sender);
